...
/*
* Header file of Si7021 Temperature Sensor Driver file
* Based on https://github.com/Csatacsibe/Si7021_driver_STM32/blob/master/driver/inc/Si7021_driver.h
*
*/
...
*                   measurement.
* INPUTS : Si7021_measurement_type_t      type      type of measurement to be done
* OUTPUTS : float*                         data      pointer to memory location where the
...
* OUTPUTS :  float*                         humidity      pointer to memory location where the
...
* INPUTS :         Si7021_resolution_t            resolution    resolution value to be set
* OUTPUTS :  Type:   int8_t                 Error code:
*            Values:  0                     OK
...
* OUTPUTS :  Type:   Si7021_resolution_t    Error code:
...
* INPUTS :          uint8_t                        current       current in mA
* OUTPUTS :  Type:   int8_t                 Error code:
*            Values:  0                     OK
*                    -1                     I2C error
...
* INPUTS :          uint8_t                        val      value of '0' means disable
...
* INPUTS :    Si7021_registers_t             reg        register to be queried
* OUTPUTS :   uint8_t*                       rv         pointer to the mermory location
*             Type:   int8_t                 Error code:
*             Values:  0                     OK
*                    -1                     I2C error or invalid register parameter
*/
int8_t get_register_Si7021(Si7021_registers_t reg, uint8_t* rv);

/************************************************************************************************
* NAME :            void init_Si7021()
* DESCRIPTION :     Initialize I2C for communication with Si7021. 
*/
void init_Si7021();
